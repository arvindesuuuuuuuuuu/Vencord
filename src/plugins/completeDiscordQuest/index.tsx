...
export default definePlugin({
    ...
    authors: [Devs.djdoolky76, Devs.nicola02nb, Devs.rozu99, Devs.syntt],
    settings,
    patches: [
        {
        ...
        switch (taskName) {
            ...
            case "PLAY_ACTIVITY":
                ...
                const playActivity = async () => {
                    ...
                    while (true) {
                        const res = await postWithRetry(`/quests/${quest.id}/heartbeat`, { stream_key: streamKey, application_id: String(applicationId || ""), terminal: false });
                        if (!res) break;
